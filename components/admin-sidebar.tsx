...
import { Bot, LayoutDashboard, Users, UserIcon as UserNurse, Video, LogOut, Activity,Bell ,MapPin} from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const menuItems = [
  ...
  { id: "nurses", title: "Nurse Management", icon: UserNurse },
  { id: "management", title: "Infrastructure Management", icon: Users },
      ...
      <SidebarHeader>
        <div className="flex items-center justify-between px-2 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-semibold dark:text-white">MedBot Admin</h2>
